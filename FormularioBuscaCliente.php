...
<center><button class="btn btn-default" type="button" onclick="location.href='ConsultaCliente.php?cpf=&nome=&codigo='">Visualizar Todos </button></center>